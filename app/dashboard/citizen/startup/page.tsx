      ...
      <div className="flex flex-col min-h-screen bg-[#0f241a]">
        ...
        <header className="bg-[#1a3a2e] px-4 py-4 border-b border-[#2d5a45]">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-[#d4a574]">Startup Hub</h1>
          </div>
        </header>
        ...
        <main className="flex-1 px-4 py-6 pb-24 overflow-y-auto">
          <Card className="mb-6 border-[#3d6a55] bg-[#2d5a45]">
            <CardContent className="p-4">
              <h2 className="font-semibold text-[#d4a574] mb-2">Launch Your Startup in Calapan</h2>
                    ...
                    <Card key={itemIdx} className="border-[#2d5a45] bg-[#1a3a2e]">
                      <CardContent className="p-4">
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 bg-[#2d5a45] rounded-xl flex items-center justify-center text-2xl flex-shrink-0">
                            {item.icon}
                          </div>
                          <div className="flex-1 min-w-0">
                            ...
                            <Button 
                              variant="ghost" 
                              size="sm" 
                              className="text-[#d4a574] hover:text-[#c49564] hover:bg-[#2d5a45] p-0 h-auto font-medium"
                            ...
                            {isExpanded && (
                              <div className="mt-3 pt-3 border-t border-[#2d5a45]">
                                <h4 className="text-sm font-semibold text-[#d4a574] mb-2">Requirements:</h4>
                                <ul className="space-y-1.5">
                                  {item.requirements.map((req, reqIdx) => (
                                    <li key={reqIdx} className="text-sm text-gray-300 flex items-start gap-2">
