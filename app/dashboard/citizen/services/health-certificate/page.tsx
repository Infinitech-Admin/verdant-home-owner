        ...
        <div className="bg-white border-b border-[#c8e6c9] sticky top-0 z-10">
          <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-[#1b5e20]">Health Certificate Application</h1>
                <p className="text-sm text-gray-600">Apply for a health certificate</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto p-4 lg:p-6">
          <div className="mb-6 p-4 bg-[#e3f2fd] border border-[#90caf9] rounded-lg">
            <p className="text-sm text-blue-800">
              Your personal information has been pre-filled from your account. You can edit any field if needed.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card className="bg-white border-[#c8e6c9]">
              <CardHeader>
                <CardTitle className="text-[#1b5e20]">Personal & Health Information</CardTitle>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="border-[#c8e6c9] focus:border-[#2e7d32] focus:ring-[#2e7d32]"
                      />
                      {formData.birthDate && <p className="text-xs text-gray-500">Auto-calculated from birth date</p>}
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="border-t border-[#c8e6c9] pt-4 space-y-4">
                    <h3 className="font-semibold text-[#1b5e20]">Medical History</h3>
