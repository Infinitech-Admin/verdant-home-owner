        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Learn how to get your Fire Safety Inspection Certificate (FSIC) in Las Piñas City
            </p>
          </div>

          <Card className="mb-6 border-l-4 border-l-[#2e7d32] bg-white border-[#c8e6c9]">
            <CardHeader>
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-[#2e7d32] mt-1" />
                <div>
                  <CardTitle className="text-lg text-[#1b5e20]">Important Notice</CardTitle>
                  <CardDescription>
                    Fire Safety Inspection Certificate (FSIC) is processed directly by the Bureau of Fire Protection
                    (BFP). The City Government of Las Piñas City does not issue FSIC. Please visit the BFP Las Piñas
                    City Fire Station.
                  </CardDescription>
                </div>
              </div>
                ...
                <ul className="space-y-2 text-sm">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-[#2e7d32] mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
          ...
          <Card className="mb-6 bg-white border-[#c8e6c9]">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[#1b5e20]">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="mt-4 p-3 bg-[#e8f5e9] border border-[#c8e6c9] rounded-lg">
          ...
          <Card className="mb-6 bg-white border-[#c8e6c9]">
            ...
            <CardContent>
              <div className="bg-[#e8f5e9] border border-[#c8e6c9] p-4 rounded-lg">
                <h4 className="font-semibold mb-2 flex items-center gap-2 text-[#1b5e20]">
                  <Flame className="w-4 h-4" />
                  Bureau of Fire Protection - Las Piñas City
                </h4>
                <div className="space-y-1 text-sm text-gray-700">
                  <p>
                    <strong>Office:</strong> BFP Las Piñas City Fire Station
                  </p>
                  <p>
                    <strong>Address:</strong> Las Piñas City
                  </p>
                  <p>
                    <strong>Office Hours:</strong> Monday to Friday, 8:00 AM - 5:00 PM
                  </p>
                  <p className="text-xs text-gray-600 mt-2">
                    Note: Contact the BFP Las Piñas City office for exact location and to schedule your inspection
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="mb-6 bg-white border-[#c8e6c9]">
            <CardHeader>
              <CardTitle className="text-[#1b5e20]">Step-by-Step Process</CardTitle>
            </CardHeader>
            <CardContent>
              <ol className="space-y-3">
                {[
                  ...
                  {
                    title: "Visit BFP Las Piñas City",
                    desc: "Go to BFP Las Piñas City Fire Station and submit application form with requirements",
                  },
                  {
                  ...
                  <li key={index} className="flex gap-3 text-sm">
                    <span className="flex-shrink-0 w-6 h-6 bg-[#2e7d32] text-white rounded-full flex items-center justify-center text-xs font-bold">
                      {index + 1}
                    </span>
                    <div>
          ...
          <Card className="mb-6 bg-white border-[#c8e6c9]">
            <CardHeader>
              <CardTitle className="text-[#1b5e20]">Fees</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600 mb-3">
              ...
              <div className="bg-[#f5f5f5] p-4 rounded-lg space-y-2 text-sm">
                ...
                <p className="text-xs text-gray-600 mt-3">
                  Note: Exact fees should be confirmed with BFP Las Piñas City office as rates may vary
                </p>
              </div>
            </CardContent>
          </Card>
