...
export default function ServiceWorkerProvider() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:max-w-md z-50 animate-in slide-in-from-bottom-5 duration-300">
      <div className="bg-gradient-to-r from-lp-green-700 to-lp-green-600 text-white rounded-lg shadow-2xl p-4 border border-lp-green-500">
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg">Install Las Piñas City App</h3>
              <p className="text-sm text-lp-green-50">
                Get quick access to city services
              </p>
            </div>
          </div>
          <button
        ...
        {isIOS ? (
          <div className="mt-3 text-sm text-lp-green-50 space-y-2">
          ...
          <Button
            ...
            className="w-full mt-3 bg-white text-lp-green-700 hover:bg-lp-green-50 font-semibold"
          >
            Install Now
          </Button>
        )}
