  ...
  return (
    <CitizenLayout>
      <div className="h-screen overflow-auto bg-gray-50">
        {/* Header */}
        <header className="bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-700 text-white px-4 sm:px-6 py-3 sm:py-4 sticky top-0 z-10 shadow-md">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-yellow-300">City News</h1>
                <p className="text-white/90 text-xs sm:text-sm mt-0.5">Latest updates from Las Piñas City</p>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12">
                <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mb-4">
                  <Calendar className="w-10 h-10 text-emerald-700" />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {filteredNews.map((article) => (
                  <Link
                    ...
                    className="group block bg-emerald-50 rounded-xl overflow-hidden shadow-sm border border-emerald-200 hover:shadow-lg hover:border-emerald-400 transition-all duration-300"
                  >
                    {article.image && (
                    ...
                    <div className="p-4 sm:p-5 bg-white">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="px-2.5 py-1 bg-emerald-700 text-white text-xs font-bold rounded-full shadow-sm">
                          {article.category}
                        </span>
                      ...
                      <h3 className="font-bold text-emerald-900 mb-2 text-base sm:text-lg leading-tight group-hover:text-emerald-700 transition-colors line-clamp-2">
                        {article.title}
                      </h3>
                      <p className="text-xs sm:text-sm text-gray-700 mb-4 leading-relaxed line-clamp-2">{article.excerpt}</p>
