          ...
          <Card className="w-full max-w-md">
            ...
            <CardContent className="space-y-4">
              <div className="bg-emerald-50 p-4 rounded-lg">
                ...
                <p className="text-xl font-bold text-emerald-700">{referenceNumber}</p>
              </div>
              ...
              {steps.map((step, index) => (
                <div key={step.number} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center ${
                        currentStep >= step.number ? "bg-emerald-700 text-white" : "bg-gray-200 text-gray-600"
                      }`}
                    >
                  ...
                  {index < steps.length - 1 && (
                    <div className={`h-1 flex-1 mx-2 ${currentStep > step.number ? "bg-emerald-700" : "bg-gray-200"}`} />
                  )}
                </div>
              ))}
            </div>
